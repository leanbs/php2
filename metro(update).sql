...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2017 at 02:36 AM
...
INSERT INTO `inventori` (`tipe_brg`, `id_merk`, `id_kategori`, `harga_barang`) VALUES
('qweqe', 2, 2, 214748);
...
CREATE TABLE `serial` (
  `id_serial` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `serial` (`id_serial`, `tipe_brg`, `serial`, `jumlah`) VALUES
(1, 'qweqe', '213213131', 123),
(2, 'qweqe', '213213231', 213),
(3, 'qweqe', '123321', 321);
...
(1, 'lalala', 'lalala', '$2y$10$HR.DpVEnIzET3v7VRcoRSeR5T3SVG2yyDVQDFcd/7c7aHDp7oSXwa', 'Qr0aLOz37KC9WaSM9FTuFPWe3c9z6MvTkAxseZLHnSCcLGKRK3XvJ2grFEMD', '2016-10-05 03:26:05', '2017-01-15 09:57:18'),
...
--
ALTER TABLE `serial`
  MODIFY `id_serial` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
